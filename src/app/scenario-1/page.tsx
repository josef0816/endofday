...
import { CinematicTransition, useCinematicTransition } from "@/components/ui-custom/cinematic-transition";
...
function ContinueButton() {
    ...
    return (
        <button
            onClick={trigger}
            className="inline-block mt-8 px-12 py-4 bg-white text-black font-oswald text-xl uppercase tracking-widest hover:bg-blue-400 transition-colors pointer-events-auto cursor-pointer"
        >
...
export default function ScenarioOne() {
    return (
        <CinematicTransition videoSrc="/transition_vid.webm" targetUrl="/scenario-2">
            <main className="min-h-screen bg-background text-foreground flex flex-col">
                ...
                <CinematicPanel
                    ...
                    subtitle="Panel 11"
                    imageSrc="/scenario2/scenario_2_panel_11.png"
                    imageAlt="Touching the interface with a fingertip"
                    variant="split-right"
                    text={<p>He touches the interface with a fingertip. No force. No drama. The gesture is minimal — because in this world, scale doesn't require strain. It requires system design.</p>}
                />

                <CinematicPanel
                    title="The Release"
                    subtitle="Panel 12"
                    imageSrc="/scenario2/scenario_2_panel_12.png"
                    imageAlt="Sleek capsule drops from the Agentic ship"
                    variant="split-left"
                    text={<p>A sleek capsule drops from the Agentic ship into cold twilight. No sparks. No grind. It doesn't fall — it commits, guided by precision.</p>}
                />
                ...
                <section className="relative w-full h-screen flex items-end">
                    ...
                    <div className="relative z-20 w-full px-6 md:px-12 pb-24 md:pb-32 flex flex-col items-center text-center">
                        <FadeIn className="max-w-4xl space-y-8">
                            ...
                            <p className="text-xl md:text-2xl text-foreground/80 font-sans font-light italic pb-8">
