    ...
    return (
        <main className="min-h-screen bg-background text-foreground flex flex-col">
            ...
            <CinematicPanel
                ...
                subtitle="Panel 01"
                imageSrc="/scenario3/scenario_3_panel_1.png"
                imageAlt="Extreme close-up of Dave's eye with electric blue light"
                variant="hero-bleed"
                priority
                text={<p>An extreme close-up of Dave's eye. Electric blue light pulses across his iris, data flickering in miniature across the surface. The glow is just a monitor. The battlefield is just work.</p>}
            />
            ...
            <CinematicPanel
                ...
                variant="split-left"
                text={<p>Dave is alone in a dark office. The timestamp on the screen reads 9:00 PM. The only sound is typing and the faint hum of machinery. This is overtime.</p>}
            />
            ...
            <CinematicPanel
                ...
                variant="split-right"
                text={<p>In the corner of the room, a sleek server tower emits a soft electric-blue glow. It's subtle, steady, patient. It doesn't intrude. It simply waits.</p>}
            />
            ...
            <CinematicPanel
                ...
                variant="hero-bleed"
                text={<p>Close-up on his hand gripping the power cable. Blue light splits across his knuckles. This is the breaking point — man reclaiming control. He begins to pull.</p>}
            />
            ...
            <CinematicPanel
                ...
                variant="full-bleed"
                text={<p>The blue light is no longer harsh. A small, almost disbelieving smile forms. He wasn't replaced. He was released. For the first time in weeks, he's ahead of the clock.</p>}
            />
